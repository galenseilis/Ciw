...
N_schedule = ciw.create_network(
    ...
    number_of_servers=[
        ciw.Schedule(
            numbers_of_servers=[1, 2, 1, 3], shift_end_dates=[30, 60, 90, 100]
        ),
        3,
    ],
...
class TestScheduling(unittest.TestCase):
    ...
    def test_full_preemptive_simulation(self):
        ...
        N = ciw.create_network(
            ...
            number_of_servers=[
                ciw.Schedule(
                    numbers_of_servers=[4, 0, 1],
                    shift_end_dates=[12.5, 17, 100],
                    preemption="resume",
                )
            ],
        )
    ...
    def test_overtime(self):
        N = ciw.create_network(
            ...
            number_of_servers=[
                ciw.Schedule(
                    numbers_of_servers=[3, 2, 1],
                    shift_end_dates=[7.0, 11.0, 20.0],
                    preemption=False,
                )
            ],
        )
    ...
    def test_priority_preemption_when_zero_servers(self):
        ...
        N = ciw.create_network(
            ...
            number_of_servers=[
                ciw.Schedule(
                    numbers_of_servers=[1, 0, 1], shift_end_dates=[20.3, 20.6, 100]
                )
            ],
        ...
        N = ciw.create_network(
            ...
            number_of_servers=[
                ciw.Schedule(
                    numbers_of_servers=[1, 0, 1], shift_end_dates=[20.3, 22, 100]
                )
            ],
            priority_classes=({"Class 0": 1, "Class 1": 0}, ["resume"]),
        )
    ...
    def test_slotted_services_with_offset(self):
        ...
        N = ciw.create_network(
            ...
            service_distributions=[ciw.dists.Deterministic(0.5)],
            number_of_servers=[
                ciw.Slotted(slots=[1, 2, 3, 4], slot_sizes=[3, 2, 5, 3], offset=0.05)
            ],
        )
        Q = ciw.Simulation(N)
        Q.simulate_until_max_time(5.6)
    ...
    def test_invalid_preemption_options(self):
        self.assertRaises(
            ValueError,
            lambda: ciw.Schedule(
                numbers_of_servers=[2, 1],
                shift_end_dates=[10, 12],
    ...
    def test_offset_error_raising(self):
        self.assertRaises(
            ValueError,
            lambda: ciw.Slotted(slots=[4, 11], slot_sizes=[3, 1], offset="something"),
        )
        self.assertRaises(
            ValueError,
            lambda: ciw.Slotted(slots=[4, 11], slot_sizes=[3, 1], offset=-6.7),
        )
        self.assertRaises(
            ValueError,
            lambda: ciw.Schedule(
                numbers_of_servers=[1, 2], shift_end_dates=[10, 25], offset="something"
            ),
        )
        self.assertRaises(
            ValueError,
            lambda: ciw.Schedule(
                numbers_of_servers=[1, 2], shift_end_dates=[10, 25], offset=-6.7
            ),
        )
    ...
    def test_schedules_with_offset(self):
        ...
        N = ciw.create_network(
            ...
            number_of_servers=[
                ciw.Schedule(
                    numbers_of_servers=[1, 0, 6, 0], shift_end_dates=[5, 20, 23, 30]
                )
            ],
        )
        Q = ciw.Simulation(N)
        ...
        N = ciw.create_network(
            ...
            number_of_servers=[
                ciw.Schedule(
                    numbers_of_servers=[1, 0, 6, 0],
                    shift_end_dates=[5, 20, 23, 30],
                    offset=0.5,
                )
            ],
        )
